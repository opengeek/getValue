...
$snippet->set('name', 'getValue');
$snippet->set('description', '<strong>'.PKG_VERSION.'-'.PKG_RELEASE.'</strong> Get a field value from any xPDOObject');
$snippet->set('category', 0);
$snippet->set('snippet', file_get_contents($sources['root'] . 'getValue.snippet.php'));
